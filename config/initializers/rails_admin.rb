# RailsAdmin config file. Generated on December 01, 2012 15:55
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Share All Tech', 'Admin']
  ...
  config.included_models = ['Comment', 'Post', 'Tag', 'User']
  ...
  config.model Tag do
    field :name do
      help "Please separate by commas."
    end
    include_all_fields
  end
